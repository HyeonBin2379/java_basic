...
public class Prob07 {
    ...
    public static void main(String[] args) {
        ...
        Map<Character, List<String>> map = numbers.stream()
                .collect(Collectors.groupingBy(fruit -> fruit.getFruitName().charAt(0), Collectors.mapping(Fruit::getFruitName, Collectors.toList())));
